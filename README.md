...
- **POS filter** — toggle noun/verb/adjective/adverb chips in the side panel; editor highlights hide/show instantly without reprocessing, and the markdown preview follows (text stays, color removed)
...
- **词性筛选** — 侧面板点击 n/v/a/o Chips 即时开关编辑器高亮（不重新分词），预览同步取消着色（保留文字）
